...
passport.use(new OneLoginStrategy({
  ...
  clientSecret: "eb3ceadd57e7b4c5b5ad596db15ce2f7e8bcecb809e59b77ce82f2f406e35cd9",
...
app.use(function(req,res,next){
  res.locals.user = { authenticated : req.isAuthenticated() };
  next();
})
...
app.get('/logout', function(req, res){
  request.post(`https://openid-connect.onelogin.com/oidc/token/revocation`, {
    'form':{
      ...
      'client_secret':"eb3ceadd57e7b4c5b5ad596db15ce2f7e8bcecb809e59b77ce82f2f406e35cd9",
